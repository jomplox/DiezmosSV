...
const ERROR_LABELS: Record<string, string> = {
  ...
  blank_us_ein: "El EIN no puede quedar vacío.",
  blank_us_legal_name: "El nombre legal no puede quedar vacío.",
  blank_us_mailing_address: "La dirección postal no puede quedar vacía.",
  blank_us_phone: "El teléfono de la organización no puede quedar vacío.",
  blank_us_signer_name: "El nombre del firmante autorizado no puede quedar vacío.",
  blank_us_signer_title: "El cargo del firmante autorizado no puede quedar vacío.",
  blank_us_time_zone: "La zona horaria no puede quedar vacía.",
  blank_us_website: "El sitio web no puede quedar vacío.",
  ...
  // El panel de Stripe precarga los ocho campos de la organización, así que un
  // guardado sin ediciones no envía nada nuevo: no es "faltan datos", es "nada que guardar".
  no_stripe_credentials_supplied: "No hay cambios que guardar.",
