...
- [ ] **Step 1: Write focused failing request-limit tests**
...
- [ ] **Step 3: Implement the body primitives**
...
- [ ] **Step 4: Convert every inbound body read in the Worker dispatcher**
...
- [ ] **Step 5: Add authorization-order RED cases**
...
- [ ] **Step 6: Verify authorization RED and implement GREEN**
...
- [ ] **Step 7: Record the security-only checkpoint**
...
- [ ] **Step 1: Write RED sibling-token tests**
...
- [ ] **Step 3: Implement the transactional repository boundary**
...
- [ ] **Step 4: Use the boundary from AuthService**
...
- [ ] **Step 5: Verify GREEN and failure atomicity**
...
- [ ] **Step 1: Write RED repository and interface tests**
...
- [ ] **Step 4: Generate and store the capability**
...
- [ ] **Step 5: Implement the atomic CAS write**
...
- [ ] **Step 6: Carry the token in client memory and header**
...
- [ ] **Step 7: Verify GREEN and migration shape**
...
- [ ] **Step 1: Write RED resolver matrix**
...
- [ ] **Step 4: Replace paid-marker and pipeline correlation paths**
...
- [ ] **Step 5: Verify both sinks and compatibility**
...
- [ ] **Step 1: Write RED pure-policy matrix**
...
- [ ] **Step 2: Verify RED and implement the pure module**
...
- [ ] **Step 3: Write RED boundary integrations**
...
- [ ] **Step 4: Enforce GREEN at every issuance boundary**
...
- [ ] **Step 5: Narrow Wrangler variables**
...
- [ ] **Step 6: Verify environment suite**
...
- [ ] **Step 1: Write RED four-role policy tests**
...
- [ ] **Step 2: Verify RED and implement projector**
...
- [ ] **Step 3: Route every audit surface through one projector**
...
- [ ] **Step 4: Verify integration surfaces**
...
- [ ] **Step 1: Write RED boundary-script tests**
...
- [ ] **Step 2: Verify RED and implement scripts**
...
- [ ] **Step 3: Update local and CI consumers**
...
- [ ] **Step 4: Write security and operations policy**
...
- [ ] **Step 5: Classify and relocate actual ignored artifacts without displaying content**
...
- [ ] **Step 6: Determine rotation status without values**
...
- [ ] **Step 7: Verify local tooling and docs**
...
- [ ] **Step 3: Re-check every original source/control/sink**
...
- [ ] **Step 4: Review only the security delta**
